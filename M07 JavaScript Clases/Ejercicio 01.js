...
function agregarStringInvertida() {
   ...
   String.prototype.reverse = function () {
      var stringSeparado = this.split();
      var stringInvertidoSeparado = [];
      for (i=0 ; i < this.length ; i++) {
         stringInvertidoSeparado.unshift(this[i]);
      }
      var stringInvertidoJunto = stringInvertidoSeparado.join("");
      return stringInvertidoJunto;
   }
}
